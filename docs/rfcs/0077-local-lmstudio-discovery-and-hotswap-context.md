...
Landed on `development` via #187 @ `b806080` (backend discovery / play / hotswap rebind) + #186 @ `3f8f6a4` (frontend local mark, play, context UX) + #185 @ `1aed4a8` (HudTopChrome Admin/Legacy overlap reflow). Prior ledger tick #190 closed without merge.

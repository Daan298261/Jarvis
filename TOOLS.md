...
| `screenshot` | Desktop capture for Qwen3.5 vision. Images are attached to the next model turn, which lazily loads the mmproj projector unless vision is set to `off`. |

...
export function MemoryPage() {
  ...
  return (
    <div>
      <h1>Memory</h1>
      <p className="lede">
        Skills are workflows Jarvis has repeated successfully. When tool arguments were recorded, they become parameters and the skill can run itself instead of only guiding the model. BrowserCode-style skills replay named clicks and fills instead of rediscovering the page. Password fields are never stored as examples and are not auto-run.
      </p>
      <div className="card">

...
export function neuralSpecialistRoute(key: string): string | undefined {
  return ROUTES.get(key)
}

export function NeuralSpecialistNav() {
  return (
...
export function NeuralChrome({
  ...
  snapshot: PresenceSnapshot
  settings: PresentationSettings
  onSelect: (selection: ApexSelection) => void
}) {

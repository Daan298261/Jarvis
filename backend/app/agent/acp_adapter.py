...
class ACPAgentAdapter:
    ...
    async def initialize(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        return {"protocolVersion": PROTOCOL_VERSION, "serverInfo": {"name": "jarvis-acp", "version": "1.3.10"}, "capabilities": {"session": True, "streaming": "normalized-events", "mcp": True, "filesystem": "delegated-only"}, "client": {"name": str(info.get("name") or ""), "version": str(info.get("version") or "")}}
